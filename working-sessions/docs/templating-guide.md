...
A guide to the four policy templates in `charts/openshift-rbac-automation/templates/rbac-policies/`. Everything here is taken from that code and
...
─────────────────────────────             ──────────────────────────────────────
Helm reads charts/openshift-rbac-automation/values.yaml              The operator reads the CR from the cluster
