...
Optional guardrail on who may write the operator's CRs (Kyverno `ValidatingPolicy`, ships in Audit; Deny was proven on
the sandbox on 2026-09-05 and `working-sessions/docs/kyverno-audit-to-deny.md` is the procedure in both directions).
